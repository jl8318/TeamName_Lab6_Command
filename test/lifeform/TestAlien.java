...
public class TestAlien
{
	...
	public void testRecoveryRate() throws MyNewException,EnvironmentException
	{
	 ...
	 */
	@Test
	public void testAttack()throws MyNewException, EnvironmentException
	{
		...
		env.addLifeForm(0, 0, al);
		env.addLifeForm(0, 1, al2);
		//normal attack
		al.attack(al2);
